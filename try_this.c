...
int is_Test = 1;                   /* Choose between 0 and 1 if you want to test(0) or use the robot(1) */
...
void initializeIP() {
    if (is_Test == 0) {
        ...
        snprintf(servIP, sizeof(servIP), "192.168.100.53");  /* Server IP of the robot change X in function of your turtlebot */
    }
}
